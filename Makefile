...
#    Updated: 2025/01/26 20:23:23 by prutkows         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = source/main.c source/builtins/builtins_utils.c source/builtins/execute.c source/builtins/ft_cd.c \
	...
	source/parser/case_dolar.c source/parser/cmd_bilder_tool.c source/parser/cmd_bilder.c source/execution/syntax.c\
